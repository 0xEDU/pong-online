...
export function Game({ gameState, playerNumber, onPaddleMove }: GameProps) {
  ...
  useEffect(() => {
    ...
    ctx.fillRect(CANVAS_WIDTH - PADDLE_WIDTH, player2.y, PADDLE_WIDTH, PADDLE_HEIGHT);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900">
      <div className="mb-4 flex justify-between w-[800px] text-white">
        <div className={`text-lg ${playerNumber === 1 ? 'text-green-400 font-bold' : 'text-blue-400'}`}>
          Player 1 {playerNumber === 1 && '(You)'}
        </div>
        <div className={`text-lg ${playerNumber === 2 ? 'text-green-400 font-bold' : 'text-blue-400'}`}>
